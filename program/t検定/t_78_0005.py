...
# 書き込み用ファイル
txtname = 't_result_nomask_s_m.txt'
f = open(txtname, 'a')
...
dir_Path1 = "nomask_seg/dict_13"
dir_Path2 = "nomask_seg/dict_65"
...
for i in range(int(len(list1) / 2)):
    ...
    list1[i] = list1[i] + list1[i + nnnnnn]
    # print(i, len(list1[i]))
# print(list1[5])

dir_Path1 = "mask/dict_13"
dir_Path2 = "mask/dict_65"
...
for i in range(int(len(list2) / 2)):
    # print(i, len(list_all[i]))
    list2[i] = list2[i] + list2[i + nnnnnn]
    # print(i, len(list1[i]))
# print(len(list2[5]))
...
# dir_Path1 = "nomask_box/dict_13"
# dir_Path2 = "nomask_box/dict_65"
# f.write(f"list1 : {dir_Path1} + {dir_Path2}")
# f.write('\n')
# file_list1 = glob.glob(os.path.join(dir_Path1, "*.txt"))
# file_list2 = glob.glob(os.path.join(dir_Path2, "*.txt"))
...
# dir_Path1 = "nonomask_box_seg/dict_13"
# dir_Path2 = "nonomask_box_seg/dict_65"
# f.write(f"list2 : {dir_Path1} + {dir_Path2}")
# f.write('\n')
# f.write('\n')
# file_list1 = glob.glob(os.path.join(dir_Path1, "*.txt"))
